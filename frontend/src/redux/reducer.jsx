...
const initialState = {
  ...
  isLoggedIn: !!userFromStorage, // Giriş durumu
  isSignedUp: false, // Kayıt durumu
  isVenueAddedUpdated: false, // Mekan ekleme/güncelleme durumu
  isDeleted: false, // Silme durumu 
  isSuccess: false, // Başarı durumu
  data: [], // Mekan verileri
  user: userFromStorage // Kullanıcı bilgileri
}
